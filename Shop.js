...
class ShopGear {
     ...
     * @param {Vendor} vendor 
     */
    constructor(name,des, price, stock, img, vendor) {
        this.name = name;
        this.des = des;
        this.price = price;
        this.stock = stock;
...
myShop.registerItem("Glasses", 500, 10, "Dell");
    ...
    return `
        <div class="card">
              <div class="content">
                ...
                <p class="copy">${ShopGear.des}</p>
                <button class="btn">Buy</button>
              </div>
            </div>`
}

let listItem = document.getElementById("list-shop-item");
listItem.innerHTML = "";

for (let item of myShop.items) {
    listItem.innerHTML += createCardItem(item);
}
